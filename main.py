...
Juventude
    """
    summary_template = """
    Dada a informação {information} a respeito de uma pessoa, crie:
    1. Um resumo curto com no máximo 50 palavras.
    2. Três tópicos importantes sobre a pessoa.
    """
